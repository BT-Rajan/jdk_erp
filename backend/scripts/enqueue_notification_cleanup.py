"""Enqueue the daily read-notification retention cleanup job
(docs/modules/notifications.md #9, background_jobs.md #10) -- point the
deployment's own cron at this, once a day:

    0 3 * * * cd /path/to/backend && .venv/bin/python -m scripts.enqueue_notification_cleanup
...
from app.jobs.cleanup_old_read_notifications import JOB_TYPE
