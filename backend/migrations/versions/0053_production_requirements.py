...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("sales_order_line_id", sa.Integer(), _fk("sales_order_lines.id", "fk_sales_order_line_fulfilments_sales_order_line_id_sales_order_lines", "RESTRICT"), nullable=False),
        sa.Column("unit_of_measure_id", sa.Integer(), _fk("units_of_measure.id", "fk_sales_order_line_fulfilments_unit_of_measure_id_units_of_measure", "RESTRICT"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("raw_material_id", sa.Integer(), _fk("raw_materials.id", "fk_production_requirement_components_raw_material_id_raw_materials", "RESTRICT"), nullable=False),
        sa.Column("quantity", sa.Numeric(precision=14, scale=4), nullable=False),
